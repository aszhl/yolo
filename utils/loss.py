...
from .metrics import bbox_iou,inner_iou
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], CIoU=True)#iou开启函数
        ...
        if type(iou) is tuple:
            ...
            loss_iou = ((1.0 - iou) * weight).sum() / target_scores_sum  #这两个if else为改动部分
